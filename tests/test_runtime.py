...
from kubeproof.domain import Assessment, ExecutionStatus, Observation, SourceClass
from kubeproof.environment import EnvironmentError
from kubeproof.helm import HelmRenderError, HelmRenderRequest
from kubeproof.kubernetes import KubernetesError
from kubeproof.profile import CompanyProfile
from kubeproof.runtime import _measure_resources, _MetricsSnapshot, _observe_dns, run_runtime
...
def _run(
    ...
    *,
    ...
    monkeypatch.setattr("kubeproof.runtime.install_metrics_server", lambda *_: None)
    return run_runtime(
